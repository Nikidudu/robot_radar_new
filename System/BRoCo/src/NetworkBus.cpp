...
//    define<SideDialPacket>(16);
    ...
    // Aimbot
    define<cvRobotModePacket>(18);
    define<cvCompetitionStatusPacket>(19);

    define<cvGimbalCommandPacket>(21);
    define<cvFiringCommandPacket>(22);
    define<cvAimCommandPacket>(23);
    define<cvAimSendPacket>(24);
}
