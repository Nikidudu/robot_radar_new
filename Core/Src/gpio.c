...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : IST_RST_Pin */
  ...
  /*Configure GPIO pin : IST_INT_Pin */
  ...
  /*Configure GPIO pin : MICROS_1_Pin */
  ...
  /*Configure GPIO pin : MICROS_2_Pin */
