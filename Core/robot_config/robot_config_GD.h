...
#ifndef TASKS_INC_ROBOT_CONFIG_GD_H_
#define TASKS_INC_ROBOT_CONFIG_GD_H_
...
#define KEYBD_MAX_SPD 			0.8				//% of max speed
...
#define FEEDER_JAM_TORQUE  		99900			//Before feeder deemed to be jammed
...
#define CHASSIS_PRIO		0.95			//% of chassis speed to be prioritised for translation
...
#define PITCH_CENTER			5435//2180//5366
...
#define YAW_CENTER 				4096//1371
#define YAW_MAX_ANG				PI-0.5//4*PI//(PI-0.5)
#define YAW_MIN_ANG				-PI+0.5//4*-PI//(-PI+0.5)
