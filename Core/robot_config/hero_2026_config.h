...
#define	PROJECTILE_SPEED		14   // 19 gives projectiles speed of 28-29m/s

#define PROJECTILE_SPEED_RATIO	330		// rpm per m/s of the friction wheels ish don't think this will work well lmao
#define FEEDER_SPEED_RATIO		-3		// projectiles per round of the feeder

// prevents pilots from overheating when firing
#define OVERHEAT_PROTECTION
#define OVERHEAT_MARGIN 	0
#define OVERHEAT_EXCESS 	0
#define OVERHEAT_OFFSET		30
...
#define FEEDER_JAM_TORQUE  		17000	//35000	//20000		// Before feeder deemed to be jammed
#define FEEDER_JAM_RPM			15		// if feeder is below this rpm, it is jammed
#define FEEDER_UNJAM_SPD  		100		// Reverse unjamming speed
#define FEEDER_UNJAM_TIME		280000

// FRICTION WHEELS PID VALUES
#define FRICTION_KP  			5
#define FRICTION_KI  			0
#define FRICTION_KD  			0
#define FRICTION_MAX_CURRENT 	0 //16384
...
#define MAX_SPEED 		    			0.23//0.5
#define MAX_ACCEL						0.40
#define CHASSIS_YAW_MAX_RPM				0.4//0.9

#define MAX_SPEED_SUPERCAP	 			0.5
#define MAX_ACCEL_SUPERCAP				0.5
#define CHASSIS_YAW_MAX_RPM_SUPERCAP	0.7

// CHASSIS WHEELS ROTATIONAL PID VALUES
#define CHASSIS_YAW_KP 			0.45 	// 0.45
#define CHASSIS_YAW_KI			0.05	//  0.05
...
#endif
#define PITCH_MAX_RPM			20
#define PITCHRPM_KP				25
...
#define YAW_ANGLE_KD			0	//3
#define YAW_ANGLE_INT_MAX		0.1
#define YAW_MAX_RPM				132		//85

#endif

#define YAWRPM_KP				40//80
#define YAWRPM_KI				0
#define YAWRPM_KD				400//300
#define YAWRPM_KFF				20
...
#define ANGLE_FEEDER
#define ANGLE_FEEDER_DELAY      10 // ms
#define ANGLE_FEEDER_MARGIN     0.05  // radian
#define ANGLE_FEEDER_SPD_MARGIN 10 // rpm
#define ANGLE_FEEDER_TIMEOUT    500 // ms
