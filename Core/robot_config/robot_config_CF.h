...
#define GEAR1_YAW_MULT			0.5
#define GEAR1_SPEED_MULT		0.1
#define GEAR1_ACCEL_MULT		1

#define GEAR2_YAW_MULT			0.5
#define GEAR2_SPEED_MULT		0.2
#define GEAR2_ACCEL_MULT		1

#define GEAR3_YAW_MULT			0.5
#define GEAR3_SPEED_MULT		0.5
#define GEAR3_ACCEL_MULT		1

#define GEAR4_YAW_MULT			1
#define GEAR4_SPEED_MULT		1
#define GEAR4_ACCEL_MULT		1.2

#define GEAR5_YAW_MULT			1
#define GEAR5_SPEED_MULT		1.5
