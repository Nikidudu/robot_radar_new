...
//check how did these numbers come about, probs from the arm config can change
#define DM4340_MAX_POSITION = 12.5
#define DM4340_MIN_POSITION = -12.5

#define DM4340_MAX_TORQUE = 10.0;
#define DM4340_MIN_TORQUE = -10.0;

#define DM4340_MAX_VELOCITY = 30 //follow software
#define DM4340_MIN_VELOCITY = -30 

//below check from datasheet, confirm correct
#define DM4340_MAX_KP = 500.00; //kp is positional scaling factor
#define DM8009_MIN_KP = 0.0;
#define DM8009_MAX_KD = 5.0; //kd is velocity scaling factor
#define DM8009_MIN_KD = 0.0;
#define DM8009_RATED_TORQUE = 20;
#define DM8009_PEAK_TORQUE = 40;
