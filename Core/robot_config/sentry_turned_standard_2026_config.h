/*
 * sentry_turned_standard_2026_config.h
 *
 *  Created on: Mar 18, 2026
 *      Author: gskan
 */

#ifndef ROBOT_CONFIG_SENTRY_TURNED_STANDARD_2026_CONFIG_H_
#define ROBOT_CONFIG_SENTRY_TURNED_STANDARD_2026_CONFIG_H_

#include "sentry_2026_hud.h"
#include "motor_config.h"

//#define ONE_VS_ONE		// 1v1 standard configuration
#define BULLET_17
#define HAS_SBC
...
#define FEEDER_SPEED			1200	// projectiles per minute / originally 1200
#define	PROJECTILE_SPEED		21.0    // 19 gives projectiles speed of 28-29m/s

#define PROJECTILE_SPEED_RATIO	300		// rpm per m/s of the friction wheels ish don't think this will work well lmao
#define FEEDER_SPEED_RATIO		-10		// projectiles per round of the feeder / originally -8

// prevents pilots from overheating when firing
#define OVERHEAT_PROTECTION
#define OVERHEAT_MARGIN 	4
...
#define FEEDER_JAM_TORQUE  		10000	//12000 35000	//20000		// Before feeder deemed to be jammed
#define FEEDER_JAM_RPM			20		// 20 if feeder is below this rpm, it is jammed
#define FEEDER_UNJAM_SPD  		10		//100	// Reverse unjam speed
#define FEEDER_UNJAM_TIME		30000	//30000
...
#define FRICTION_SB_SPIN		1.0 // ratio of max flywheel speed
...
#ifdef ONE_VS_ONE
	#define MAX_SPEED 		    	0.26 //0.23
	#define MAX_ACCEL				0.5
	#define CHASSIS_YAW_MAX_RPM   	0.50//0.50
	#define SPINSPIN_SPEED_BOOST 	0.10
#else // 3v3 HP-focused
	#define MAX_SPEED 		    	0.08 //0.23
	#define MAX_ACCEL				0.5
	#define CHASSIS_YAW_MAX_RPM   	0.40 //0.50
	#define SPINSPIN_SPEED_BOOST	0.10		// Increase in CHASSIS_YAW_MAX_RPM (aka spinspin speed) when chassis is stationary
#endif

#define MAX_SPEED_SUPERCAP 				0.5
#define MAX_ACCEL_SUPERCAP 				1
#define CHASSIS_YAW_MAX_RPM_SUPERCAP 	0.95

// CHASSIS CENTERING: Sentry uses cascaded PID (angle outer + speed inner)
#define CHASSIS_YAW_ANGLE_KP      1.2
#define CHASSIS_YAW_ANGLE_KI      0
#define CHASSIS_YAW_ANGLE_KD      0.05
#define CHASSIS_YAW_ANGLE_INT_MAX  0.1
#define CHASSIS_YAW_ANGLE_MAX_OUT  2	// angle PID max output (target yaw rate)
#define CHASSIS_YAW_RPM_KP        0.22f
#define CHASSIS_YAW_RPM_KI        0
#define CHASSIS_YAW_RPM_KD        0.1
#define CHASSIS_YAW_RPM_INT_MAX    1000
#define CHASSIS_YAW_RPM_MAX_OUT    100	// rpm PID max output (final yaw command)
// Legacy single-loop (hero, pancake)
...
#define SPIN_ACCELERATION		1	// increase in
#define CHASSIS_SPEED_BOOST		0.10	// Increase in MAX_SPEED when spinspin mode is deactivated
...
#define PITCHRPM_KP				20
#define PITCHRPM_KI				0.001
#define PITCHRPM_KD				80
#define PITCHRPM_INT_MAX		4000
#define PITCH_MAX_CURRENT		205000

#else

#define DM_PITCH_KP				11
...
#define PITCH_MAX_ANG			0.484848571
#define PITCH_MIN_ANG			-0.3//-0.645605505
...
#define YAW_MOTOR_ID 		0x2	// DM4310 DJI mode: 1=pitch, 2=yaw (same CAN packet)
...
#endif /* ROBOT_CONFIG_SENTRY_TURNED_STANDARD_2026_CONFIG_H_ */
