...
#define ROBOT_CONFIG_ROBOT_CONFIG_SENTRY_H_
...
#define LV1_MAX_SPEED				0.2//4500//M3508_MAX_RPM
#define LV1_MAX_ACCEL				2.0
#define LVL1_CHASSIS_YAW_MAX_RPM	0.4
...
#define PITCH_MAX_ANG			5//0.6
#define PITCH_MIN_ANG			-5//-0.05
