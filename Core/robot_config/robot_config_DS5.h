...
#define FEEDER_JAM_RPM			500				// if feeeder is below this rpm, it is jammed
...
#define CHASSIS_SPINSPIN_MAX 0.6
...
#define PITCHRPM_KP				5000//400
#define PITCHRPM_KI				10//0.1
