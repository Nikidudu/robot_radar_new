...
#define CHASSIS_KP  		4//8				// |
#define CHASSIS_KI  		0.1//0//0.1				// | - CHASSIS WHEELS PID VALUES
#define CHASSIS_KD  		0.4//0//1				// |
...
#define CHASSIS_YAW_KP 		0.5//0.6//2//3.75//1//0.7//0.4
#define CHASSIS_YAW_KI		0.01//0
#define CHASSIS_YAW_KD 		0.05//0.1//1.8//0
...
//#define YAW_MOTOR_TYPE			TYPE_6020 //to be changed for sentry
...
#define YAW_CENTER 				-814//0//2790//7870//
