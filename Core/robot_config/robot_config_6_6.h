...
//#define BOARD_DOWN
//relative to SWDIO port's short axis (the direction the short axis is aligned to)
//0 for SWDIO port to be horizontal and roll
//1 for SWDIO port to be horizontal and pitch
//2 for SWDIO port to be vertical and yaw
//3 for SWDIO port to be vertical and roll
//4 for SWDIO port to be vertical and pitch
#define IMU_ORIENTATION	4
...
#define	LV1_PROJECTILE			6//`b0//18//20//12
...
#define CHASSIS_YAW_KP 		1.5//0.7//0.4
...
#define PITCH_ANGLE_KP	  		10//20//200
...
#define PITCH_CENTER			5300//3590
#define PITCH_MAX_ANG			0.30
#define PITCH_MIN_ANG			-0.30
#define PITCH_CONST 			0


#define YAW_ANGLE_KP			8//200
#define YAW_ANGLE_KI			0
#define YAW_ANGLE_KD			0
#define YAW_ANGLE_INT_MAX		0.05
#define YAW_MAX_RPM				5//20
...
#define RFRICTION_MOTOR_ID	7
#define RFRICTION_MOTOR_CAN_PTR	&hcan1

#define FEEDER2_MOTOR_ID		3
#define FEEDER2_MOTOR_CAN_PTR	&hcan1
#define LFRICTION2_MOTOR_ID	2
#define LFRICTION2_MOTOR_CAN_PTR	&hcan1
#define RFRICTION2_MOTOR_ID	1
#define RFRICTION2_MOTOR_CAN_PTR	&hcan1
