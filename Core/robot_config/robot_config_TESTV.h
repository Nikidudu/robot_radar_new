...
#define CHASSIS_YAW_KP 		2//0.7//0.4
...
#define YAW_CENTER 				6848//2790
#define YAW_MAX_ANG				(PI-0.4)
#define YAW_MIN_ANG				(-PI+0.4)
...
//#define CHASSIS_MCU
#ifndef CHASSIS_MCU
#define FR_MOTOR_ID 		7
#define FL_MOTOR_ID 		6
#define BL_MOTOR_ID 		5
