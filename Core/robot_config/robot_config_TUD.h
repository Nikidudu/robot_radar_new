...
#define ANGLE_FEEDER
#define ANGLE_FEEDER_MARGIN		0.1 //margin in radians
#define ANGLE_FEEDER_SPD_MARGIN 10 //rpm after gearbox margin
#define ANGLE_FEEDER_TIMEOUT    1000 //if stuck in angle feeder for more than 2s, timeout
...
#define FRICTION_OFFSET			9000//100
