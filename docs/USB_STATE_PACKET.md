...
The STM32 sends a **state number** (0–20) over USB at 50 Hz. This doc describes how to read it on the PC.

**Baud rate:** Use 921600 for higher throughput. The firmware defaults to 921600 8N1. USB CDC transfers at USB speed (12 Mbps); the baud rate is for host compatibility.
...
ser = serial.Serial("COM3", 921600)  # or /dev/ttyACM0 on Linux; use 921600 for higher throughput
